...
func (p GlobalStateExamplesDef) Render() react.Element {
	...
	return react.Div(&react.DivProps{ClassName: "container"},
		...
		<p>State trees generated by <a href="https://github.com/myitcv/x/tree/master/react/cmd/stateGen">
		...
		<p>The source code for the example that follows can be found <a href="https://github.com/myitcv/x/tree/master/react/examples/globalstate">
		Github repo</a>.
		`)}),
	)
}
